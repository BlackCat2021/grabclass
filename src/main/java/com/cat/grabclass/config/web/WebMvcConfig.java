package com.cat.grabclass.config.web;

import com.cat.grabclass.interceptor.LoginInterceptor;
import com.cat.grabclass.interceptor.RateLimiterInterceptor;
...
public class WebMvcConfig extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(loginInterceptor).addPathPatterns("/**")
                .excludePathPatterns("/grabclass/user/login")
